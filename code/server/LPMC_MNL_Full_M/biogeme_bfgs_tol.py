...
if __name__ == "__main__":
    ...
    print("Train LPMC_MNL_Full with current Biogeme optimization algorithm.")

    model = LPMC_MNL_Full(data_folder)
    ...
    for i in range(20):
        ...
        start = time.time()
        results = model.biogeme.estimate(gtol=0.014797180351006444)
        tme = time.time() - start
